...
const ProductEntry = ({ movements, products }) => {
  // Hooks
      ...
      axios
        ...
        .then((resp) => {
          axios
            ...
            .then((resp) => {
              let newCantidad =
                resp.data.producto.cantidad + Number(newMovement.cantidad);
              let data = {
                nombre: resp.data.producto.nombre,
                precioUni: resp.data.producto.precioUni,
                categoria: resp.data.producto.categoria._id,
                disponible: resp.data.producto.disponible,
  ...
  let movementsEntrada = [];

  if (movements !== undefined) {
    movementsEntrada = movements.filter((c) => c.nombre === "Entrada");
  }
